...
namespace WebShop.Controllers
{
    public class ItemController : Controller
    {
        public IActionResult Index(int id)
        {
            ...
            //  preču atlase no DB pēc kategorijas id, izm. ItemManager

            model.Items = ItemManager.GetByCategory(id).Select(i => i.ToModel()).ToList();
        ...
        {
            // jāsaglabā izvēlētā prece lietotāja grozā.
